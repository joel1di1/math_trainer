...
ActiveRecord::Schema[7.1].define(version: 20_240_508_173_150) do
  ...
  create_table 'math_trainer_answer_fights', force: :cascade do |t|
    t.bigint 'answer_id', null: false
    t.bigint 'fight_id', null: false
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
  ...
  create_table 'math_trainer_answers', force: :cascade do |t|
    t.bigint 'user_id', null: false
    t.bigint 'problem_id', null: false
    t.string 'text'
    t.datetime 'created_at', null: false
  ...
  create_table 'math_trainer_answers_sessions', force: :cascade do |t|
    t.bigint 'answer_id', null: false
    t.bigint 'time_session_id', null: false
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
  ...
  create_table 'math_trainer_ar_internal_metadata', primary_key: 'key', id: :string, force: :cascade do |t|
    t.string 'value'
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
  end

  create_table 'math_trainer_card_session_problems', force: :cascade do |t|
    t.bigint 'problem_id', null: false
    t.bigint 'card_session_id', null: false
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
  ...
  create_table 'math_trainer_card_sessions', force: :cascade do |t|
    t.string 'title'
    t.bigint 'user_id'
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
  ...
  create_table 'math_trainer_fight_opponents', force: :cascade do |t|
    t.string 'name'
    t.integer 'health'
    t.integer 'speed'
    t.integer 'color_rot'
  ...
  create_table 'math_trainer_fights', force: :cascade do |t|
    t.bigint 'fight_opponent_id', null: false
    t.bigint 'user_id', null: false
    t.integer 'remaining_player_health'
    t.integer 'remaining_opponent_health'
  ...
  create_table 'math_trainer_problems', force: :cascade do |t|
    t.string 'type'
    t.integer 'number_1'
    t.integer 'number_2'
  ...
  create_table 'math_trainer_schema_migrations', primary_key: 'version', id: :string, force: :cascade do |t|
  end

  create_table 'math_trainer_time_sessions', force: :cascade do |t|
    t.bigint 'user_id', null: false
    t.integer 'minutes'
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
  ...
  create_table 'math_trainer_users', force: :cascade do |t|
  ...
  add_foreign_key 'math_trainer_answer_fights', 'math_trainer_answers', column: 'answer_id'
  add_foreign_key 'math_trainer_answer_fights', 'math_trainer_fights', column: 'fight_id'
  add_foreign_key 'math_trainer_answers', 'math_trainer_card_sessions', column: 'card_session_id'
  add_foreign_key 'math_trainer_answers', 'math_trainer_problems', column: 'problem_id'
  add_foreign_key 'math_trainer_answers', 'math_trainer_users', column: 'user_id'
  add_foreign_key 'math_trainer_answers_sessions', 'math_trainer_answers', column: 'answer_id'
  add_foreign_key 'math_trainer_answers_sessions', 'math_trainer_time_sessions', column: 'time_session_id'
  add_foreign_key 'math_trainer_card_session_problems', 'math_trainer_card_sessions', column: 'card_session_id'
  add_foreign_key 'math_trainer_card_session_problems', 'math_trainer_problems', column: 'problem_id'
  add_foreign_key 'math_trainer_card_sessions', 'math_trainer_users', column: 'user_id'
  add_foreign_key 'math_trainer_fights', 'math_trainer_fight_opponents', column: 'fight_opponent_id'
  add_foreign_key 'math_trainer_fights', 'math_trainer_users', column: 'user_id'
  add_foreign_key 'math_trainer_time_sessions', 'math_trainer_users', column: 'user_id'
